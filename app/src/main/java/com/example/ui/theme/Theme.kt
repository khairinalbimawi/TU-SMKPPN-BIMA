...
private val DarkColorScheme =
  darkColorScheme(
    primary = SleekPurpleDarkPrimary,
    secondary = SleekPurpleDarkSecondary,
    tertiary = SleekPurpleDarkTertiary,
    ...
    onBackground = OnSleekBackgroundDark,
    onSurface = OnSleekSurfaceDark
  )
...
private val LightColorScheme =
  lightColorScheme(
    ...
    onBackground = OnSleekBackground,
    onSurface = OnSleekSurface
  )
